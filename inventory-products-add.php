  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="inventory-products-add.php">Add Components</a></li>
      </ol>
    </nav>
  </div>
    ...
    <div class="row">
      <div class="">
        ...
        <div class="card">
          ...
          <?php require_once 'process-products-add.php'; ?>
          <form action="process-products-add.php" method="POST">
            <div class="row mb-3">
