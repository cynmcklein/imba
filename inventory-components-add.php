  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="inventory-components.php">Inventory</a></li>
        <li class="breadcrumb-item active"><a href="inventory-components-add.php">Add Components</a></li>
      </ol>
    </nav>
  </div>
    ...
    <div class="row">
      <div class="">
        ...
        <div class="card">
          ...
          <?php require_once 'process-components-add.php'; ?>
          <form action="process-components-add.php" method="POST">
