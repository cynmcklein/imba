...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Scan RFID for Components</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="production.php">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="scan-rawmaterials.php">Scan Components--</a></li>
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <h5 class="card-title">Component Description</h5>
                        ...
                        <form action="process-rawmaterials-add.php" method="POST">
                            ...
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-2 col-form-label">Equipment</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="Supplier Name" class="col-sm-2 col-form-label">Role</label>
                                <div class="col-sm-10">
