...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Scan RFID for Raw Materials</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="production.php">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="scan-rawmaterials.php">Scan Raw Material</a></li>
            ...
            <div class="col-lg-5">
                <div class="col-md-10">
                    ...
                    <div class="alert alert-danger">
                        <strong>Note:</strong> Please scan the ID after taking photo otherwise the data would not be save.
                    </div>
                    <br /><br /><br /><br /><br /><br />
