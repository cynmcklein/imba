      ...
      <div class="modal-content">
        ...
        <form action="process-purchaserawmaterials-add.php" method="POST">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="save" class="btn btn-primary" data-bs-dismiss="modal">Save changes</button>
          </div>
      ...
      <div class="card-body">
        ...
        <table class="table table-borderless datatable">
          ...
          <tbody>
            ...
            $query = mysqli_query($data, "SELECT * FROM purchaserawmaterials");
                ...
                <td>
                  ...
                  <ul class="list-inline m-0">
                    ...
                    <li class="list-inline-item">
                      ...
                      <div class="col-12">
                        <a href='purchases-rawmaterials-print.php?print=<?php echo $row['id']; ?>'><button class="btn btn-info ri-printer-fill" type="button" data-bs-toggle="modal" data-bs-target="#verticalycentered"></button></a>
                        <div class="modal fade" id="verticalycentered" tabindex="-1">
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <a href='purchases-rawmaterials-print.php?print=<?php echo $row['id']; ?>'><button type="button" class="btn btn-primary">Print</button></a>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <li class="list-inline-item">
                      <a href='delete-purchaseorder.php?delete=<?php echo $row['id']; ?>'><button class="btn btn-danger ri-delete-bin-6-line" name="btnDelete" type="button" data-toggle="tooltip" data-placement="top" title="Delete"></button></a>
                    </li>
