    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
      ...
      <div class="logo d-flex align-items-center">
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          <span class="d-none d-lg-block">Inventory Management for Big Apple</span>
        </a>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-menu-button-wide"></i><span>Scan and Inventory</span><i class="bi bi-chevron-down ms-auto"></i>
          </a>
          <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">

            <li>
              <a href="scan-rawmaterials.php">
                <i class="bi bi-circle"></i><span>Raw Materials</span>
              </a>
            </li>

            <a href="scan-components.php">
              <i class="bi bi-circle"></i><span>Components</span>
            </a>

            <li>
              <!-- <a href="scan-product.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>Supplier Information</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="users-profile-prod.php">
            <i class="bi bi-person"></i>
            <span>Profile</span>
          </a>
