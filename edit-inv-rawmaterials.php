 <?php
    ...
    if (isset($_POST['save'])) {
        ...
        $sql = "UPDATE rawmaterials SET itemcode = '$code', itemname = '$itemname', itemname ='$itemname', itemtype = '$material', suppliername = '$supplier', quantity = '$qty' WHERE id ='$id'";
        ...
        header("Location: inventory-rawmaterials.php?edit=" . $id);
    }


    $query = mysqli_query($data, "SELECT * FROM rawmaterials WHERE id= '$id'");
         ...
         <main id="main" class="main">
             ...
             <form action="" method="POST">
                 ...
                 <div class="row mb-3">
                     ...
                     <div class="col-sm-10">
                         <input type="text" name="suppliername" class="form-control" id="suppliername" value="<?php echo $row['suppliername']; ?>">
                     </div>
                 </div>
