        ...
        <section class="section">
            <div class="row">
                <div class="">
                    ...
                    <div class="container">
                        <button type="" class="btn btn-info noprint" style="width: 100%;" onclick="window.location.replace('inventory-components.php');">Cancel Printing</button>
                    </div>
