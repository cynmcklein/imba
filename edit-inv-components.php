 <?php
    ...
    if (isset($_POST['save'])) {
        ...
        $sql = "UPDATE components SET itemcode = '$code', itemname = '$itemname', itemname ='$itemname', itemtype = '$material', suppliername = '$supplier', quantity = '$qty' WHERE id ='$id'";
        ...
        header("Location: inventory-components.php?edit=" . $id);
    }


    $query = mysqli_query($data, "SELECT * FROM components WHERE id= '$id'");
