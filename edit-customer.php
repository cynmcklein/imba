 <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE customer SET company = '$name', email = '$email', contact ='$contact', conperson = '$conperson',     address = '$address' WHERE id ='$id'";
    ...
    $query = mysqli_query($data, "SELECT * FROM customer WHERE id= '$id'");
             ...
             <form action="" method="POST">
                 <div class="modal-body">
                     <div class="col-md-12">
                         ...
                         <input type="text" name="companyName" class="form-control" id="companyName" value="<?php echo $row['company']; ?>">
                     </div>
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                         ...
                         <input type="integer" name="contact" class="form-control" id="contact" value="<?php echo $row['contact']; ?>">
                     </div>
                     <div class="col-12">
                         <label for="inputAddress5" class="form-label">Contact Person </label>
                         <input type="text" name="conPerson" class="form-control" id="conPerson" value="<?php echo $row['conperson']; ?>">
                     </div>
                     <div class="col-12">
                         <label for="inputAddress2" class="form-label">Address </label>
                         <input type="text" name="address" class="form-control" id="address" placeholder="Apartment, studio, or floor" value="<?php echo $row['address']; ?>">
                     </div>
                     ...
                     <div class="modal-footer">
                         ...
                         <button type="submit" name="submit" class="btn btn-primary" data-bs-target="#basicmodal">Save changes</button>
                     </div>
