...
if (isset($_POST['submit'])) {
  ...
  if ($photo->process_user($user_id)) {
    ...
    header('Location: users-profile-prod.php');
  } else {
...
?>
<?php //include_once 'production-header-sidebar.php';
?>
  ...
  <div class="row">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-md-8">
              <form class="form" action="users-profile-prod.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form method="post" action="users-profile-prod.php?id=<?php echo (int)$user['id']; ?>" class="clearfix">
            <div class="form-group">
